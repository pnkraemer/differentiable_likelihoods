...
# Draw a grid
delta = 0.003125
xpts = np.arange(0.6, 0.75, delta)
ypts = np.arange(0, .1, delta)
...
plt.quiver(X, Y, gradgrid1, gradgrid2, color='blue', width=0.125*1e-2, alpha=0.75)
plt.quiver(X, Y, diffquot1, diffquot2, color='orange', width=0.125*1e-2, alpha=0.75)
# plt.xlim((0.5, 4.5))
# plt.ylim((0.5, 4.5))
plt.show()
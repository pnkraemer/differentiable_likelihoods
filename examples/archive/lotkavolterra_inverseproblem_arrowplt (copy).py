...
nsamps = 1
fixedparams = [0.01, 0.02]
init_theta = np.array([2, 2])
...
ivp = LotkaLike(initial_time, end_time, fixparams=fixedparams, flexparams=thetatrue, initval=initial_value, initval_unc=0.0)
print(ivp.params)
